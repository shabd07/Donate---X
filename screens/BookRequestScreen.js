...
export default class BookRequestScreen extends Component{
  ...
  addRequest = async (bookName,condition)=>{
    var userId = this.state.userId
    var randomRequestId = this.createUniqueId()
    db.collection('requested_books').add({
        "user_id": userId,
        "book_name":bookName,
        "reason_to_request":condition,
    ...
    if(this.state.IsBookRequestActive === true){
      return(
        ...
        <View style = {{flex:1,justifyContent:'center'}}>
          ...
          <Text>Thing That You Want To Donate</Text>
        ...
        <View style={{flex:1}}>
          ...
          <ScrollView>
            <KeyboardAvoidingView style={styles.keyBoardStyle}>
              ...
              <TouchableOpacity
                style={styles.button}
                onPress={()=>{ this.addRequest(this.state.bookName,this.state.condition,this.state.contact);
                }}
                >
                <Text>Donate</Text>
              </TouchableOpacity>
